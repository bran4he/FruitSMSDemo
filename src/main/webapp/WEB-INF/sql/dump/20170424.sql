...
INSERT INTO `t_pub_config` VALUES 
(1,'ORDER_DAY_TO','25','最大的不可下订单日期','2017-04-13 04:01:55','admin','2017-04-13 04:01:55','admin')
,(2,'RECEIVER_EFF_YEAR','3','收礼人账户建立后的默认有效期','2017-04-13 04:01:55','admin','2017-04-13 04:01:55','admin')
,(3,'WECHAT_SERVER_URL','http://localhost:8080/TryNewFruit/','微信后台的地址用于调用发短信接口','2017-04-13 04:01:55','admin','2017-04-13 04:01:55','admin')
,(4,'RECIVER_SMS_CONTENT','RECIVER_SMS_CONTENT','亲爱的用户，恭喜您收到水果啦，请到微信公众号xxx激活手机号并领取水果。', '用户分配到水果后收到的短信内容','2017-04-13 04:01:55','admin','2017-04-13 04:01:55','admin');
